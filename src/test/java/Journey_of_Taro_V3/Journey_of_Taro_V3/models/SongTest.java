...
class SongTest {
    ...
    public void testSongCreation() {
        // Mock CustomMultipartFile
        CustomMultipartFile songFile = mock(CustomMultipartFile.class);
        ...
        try {
            ...
            throw new BadRequestException("Error getting bytes from CustomMultipartFile");
        }
