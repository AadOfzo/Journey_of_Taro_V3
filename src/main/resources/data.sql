...
VALUES (1001, 'Example_Admin_1', '$2a$10$wtKjdXOpg9dP..1xbxk2ouv6rWOW.kGaX1vhKxgAy.G6aGL./AGVW', '7lcjpziAtuwtTyjaIUeq', 'Test_FirstName_1', 'Test_LastName_1', '18-03-2023', 'the Netherlands','admin@testemail.com', 'Test_Artist_Name_1'),
       (1002, 'Example_User_1', 'eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJFeGFtcGxlX1VzZXJfMSIsImlhdCI6MTcxODg4MTMwNCwiZXhwIjoxNzE5NzQ1MzA0fQ.0mGAxJNNSp4_T4I9FBBQYMAEgn_PO8sbntN9jTzS8FU', 'sQXMUVcOjXe83PeUJAfN', 'Test_FirstName_1', 'Test_LastName_1', '21-05-2013', 'Belgium','user@testemail.com', 'User_Artist_123');
