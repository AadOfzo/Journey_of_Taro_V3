...
import Journey_of_Taro_V3.Journey_of_Taro_V3.services.CustomUserDetailsService;
...
//                .requestMatchers(HttpMethod.POST,"/songCollectionTypes/**").hasRole("ADMIN")
//                .requestMatchers(HttpMethod.DELETE, "/songCollectionTypes/**").hasRole("ADMIN")
                // Je mag meerdere paths tegelijk definieren
                .requestMatchers("/cimodules", "/remotecontrollers", "/televisions", "/wallbrackets", "/songs").hasAnyRole("ADMIN", "USER")
